...
export type StyleSpecification = {
	...
	/**
	 * A style's `layers` property lists all the layers available in that style. The type of layer is specified by the `type` property, and must be one of `background`, `fill`, `line`, `symbol`, `raster`, `circle`, `fill-extrusion`, `heatmap`, `fill-heatmap`, `hillshade`, `color-relief`.
	 *
...
export type FillHeatmapLayerSpecification = {
	/**
	 * Unique layer name.
	 */
	"id": string;
	...
	"paint"?: {
		/**
		 * A measure of how many overlapping polygons are necessary to reach the maximum color value.  Counts greater than this value will render as the maximum color.
		 *
		 * @default
		 * ```json
		 * 100
		 * ```
		 */
		"fill-heatmap-limit-count"?: DataDrivenPropertyValueSpecification<number>;
		/**
		 * Defines the color of each pixel based on its density value in a heatmap.  Should be an expression that uses `["heatmap-density"]` as input.
		 *
		 * @default
		 ...
		 * ```
		 */
		"fill-heatmap-color"?: ExpressionSpecification;
		/**
		 * The global opacity at which the heatmap layer will be drawn.
		 *
		 * @default
		 ...
		 * ```
		 */
		"fill-heatmap-opacity"?: PropertyValueSpecification<number>;
		"fill-heatmap-opacity-transition"?: TransitionSpecification;
	};
};
...
export type LayerSpecification = FillLayerSpecification | LineLayerSpecification | SymbolLayerSpecification | CircleLayerSpecification | HeatmapLayerSpecification | FillExtrusionLayerSpecification | FillHeatmapLayerSpecification | RasterLayerSpecification | HillshadeLayerSpecification | ColorReliefLayerSpecification | BackgroundLayerSpecification;
